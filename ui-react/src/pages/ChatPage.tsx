      ...
      <div className="arc-composer-dock mx-auto w-full max-w-3xl px-4 pb-4 sm:px-8">
        {attachName && (
          <div className="mb-2 flex justify-center">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-cyan-400/10 px-3 py-1 text-[11.5px] text-[#007AFF]">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setSheetOpen(false)}
            ...
            <motion.div initial={{ y: 60, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 60, opacity: 0 }}
              ...
              <button onClick={() => fileRef.current?.click()}
                ...
                <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-cyan-400/10 text-[#007AFF]">
